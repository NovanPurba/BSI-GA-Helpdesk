...
<body>
    <div class="main-container">
        ...
        <h1 class="title">OPSI REQUEST</h1>
        <p class="subtitle">Pilih kategori permintaan Anda</p>

        <div class="category-grid">
            <a href="<?= site_url('request/fuel_options') ?>" class="category-btn">FUEL</a>
            <a href="<?= site_url('request/carpool_options') ?>" class="category-btn">CARPOOL</a>
            <a href="<?= site_url('request/form/it') ?>" class="category-btn">IT</a>
            <a href="<?= site_url('request/form/gim') ?>" class="category-btn">GIM</a>
            <a href="<?= site_url('request/form/ga') ?>" class="category-btn full-width">GA</a>
        </div>
    </div>
</body>
</html>