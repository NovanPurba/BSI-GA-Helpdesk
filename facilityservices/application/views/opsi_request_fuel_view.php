...
<head>
    ...
    <style>
        ...
        .category-btn { background: #121c2d; border: 1px solid #24344d; border-radius: 14px; padding: 22px 12px; text-decoration: none; color: #fff; font-size: 13px; font-weight: 700; letter-spacing: 0.5px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 20px rgba(0,0,0,0.3); text-transform: uppercase; }
        ...
        .category-btn.full-width { grid-column: span 2; font-size: 14px; }
    </style>
</head>
<body>
    <div class="main-container">
        ...
        <h1 class="title">REQUEST FUEL</h1>
        <p class="subtitle">Pilih jenis layanan Fuel yang dibutuhkan</p>

        <div class="category-grid">
            <a href="<?= site_url('request/form/fuel/isi_fuel') ?>" class="category-btn">ISI FUEL</a>
            <a href="<?= site_url('request/form/fuel/charging') ?>" class="category-btn">CHARGING</a>
            
            <a href="<?= site_url('request/form/fuel/pemasangan_rfid') ?>" class="category-btn">PEMASANGAN RFID</a>
            <a href="<?= site_url('request/form/fuel/pelepasan_rfid') ?>" class="category-btn">PELEPASAN RFID</a>
            
            <a href="<?= site_url('request/form/fuel/pemindahan_rfid') ?>" class="category-btn full-width">PEMINDAHAN RFID</a>
        </div>
    </div>
</body>
</html>